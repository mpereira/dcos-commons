...
def verify_client_can_write_read_and_delete(dcos_ca_bundle=None):
    write_data_job = get_write_data_job(dcos_ca_bundle=dcos_ca_bundle)
    verify_data_job = get_verify_data_job(dcos_ca_bundle=dcos_ca_bundle)
    delete_data_job = get_delete_data_job(dcos_ca_bundle=dcos_ca_bundle)
    verify_deletion_job = get_verify_deletion_job(dcos_ca_bundle=dcos_ca_bundle)
